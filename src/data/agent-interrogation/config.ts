...
export const overview = {
  ...
  methodology: [
    ...
    },
    {
      ...
      description:
        "For this experiment I used the Claude Sonnet 4.6 API for both agents and the judge. I used VSCode for the creation of this experiment. I used Claude code to assist me in the creation of the code for this project. A local SQLite database was used to store all each trial’s data.",
    },
  ],
};
